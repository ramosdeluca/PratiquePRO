...
export const TermsContent: React.FC = () => (
    <div className="space-y-4">
        ...
        <p>Após o cancelamento, o acesso à plataforma e às funcionalidades pagas é encerrado imediatamente, independentemente da existência de período restante no ciclo contratado.</p>
        <p>Não há reembolso de valores já pagos, salvo quando expressamente exigido pela legislação aplicável.</p>

        <h4 className="font-bold text-white mt-4">5. Créditos, Limites de Uso e Consumo</h4>
        <p>Alguns planos podem incluir limites de uso, como créditos, minutos ou quantidade de sessões.</p>
        <p>O consumo ocorre conforme o uso efetivo da plataforma.</p>
        <p>Créditos não utilizados podem expirar e não são acumuláveis, conforme as regras do plano.</p>
        <p>Tentativas de burlar limites, explorar falhas técnicas ou automatizar o uso indevidamente poderão resultar em bloqueio imediato da conta.</p>

        <h4 className="font-bold text-white mt-4">6. Uso de Inteligência Artificial</h4>
        ...
        <p>Ao utilizar o serviço, o usuário autoriza o uso dos dados de forma anonimizada para fins de melhoria da plataforma, desempenho e qualidade do serviço.</p>
        ...
        <ul className="list-disc pl-5 space-y-1">
            ...
            <li>tentativa de exploração de falhas</li>
            <li>descumprimento de leis aplicáveis</li>
        </ul>
        ...
        <p>Em caso de alterações relevantes, o usuário será informado por meio da plataforma. O uso contínuo do serviço após a atualização implica concordância com os novos Termos.</p>

        <h4 className="font-bold text-white mt-4">11. Legislação e Foro</h4>
        <p>Estes Termos são regidos pelas leis da República Federativa do Brasil.</p>
        <p>Fica eleito o foro do domicílio do usuário, nos termos da legislação vigente.</p>

        <h4 className="font-bold text-white mt-4">12. Contato</h4>
        <p>Em caso de dúvidas, entre em contato pelo e-mail: 📧 rdlsoftwares@gmail.com</p>
    </div>
);
...
export const PrivacyContent: React.FC = () => (
    <div className="space-y-4">
        <p className="text-sm text-gray-400">Última atualização: 07/02/2026</p>
        <p>A sua privacidade é importante para nós. Esta Política descreve como coletamos, usamos e protegemos seus dados pessoais, em conformidade com a LGPD (Lei nº 13.709/2018).</p>

        <h4 className="font-bold text-white mt-4">1. Dados Coletados</h4>
        <p>Podemos coletar:</p>
        <ul className="list-disc pl-5 space-y-1">
            <li>Nome e e-mail</li>
            <li>Dados de autenticação</li>
            <li>Histórico de sessões e interações</li>
        ...
        <ul className="list-disc pl-5 space-y-1">
            ...
            <li>liberar funcionalidades contratadas</li>
            <li>gerar feedbacks personalizados</li>
            <li>melhorar a experiência do usuário</li>
            <li>cumprir obrigações legais</li>
        </ul>

        <h4 className="font-bold text-white mt-4">3. Compartilhamento de Dados</h4>
        <p>Seus dados podem ser compartilhados com:</p>
        <ul className="list-disc pl-5 space-y-1">
            <li>Supabase (infraestrutura e autenticação)</li>
            <li>Asaas (pagamentos)</li>
            <li>Google (Gemini) para processamento de IA</li>
        </ul>
        <p>Sempre respeitando padrões de segurança e privacidade.</p>

        <h4 className="font-bold text-white mt-4">4. Armazenamento e Segurança</h4>
        <p>Utilizamos medidas técnicas e organizacionais para proteger os dados.</p>
        <ul className="list-disc pl-5 space-y-1">
            <li>Os dados são armazenados em ambientes seguros.</li>
            <li>O acesso é restrito e monitorado.</li>
        </ul>

        <h4 className="font-bold text-white mt-4">5. Direitos do Usuário</h4>
        ...
        <p>Basta entrar em contato pelo e-mail informado abaixo.</p>

        <h4 className="font-bold text-white mt-4">6. Retenção de Dados</h4>
        <p>Os dados são mantidos enquanto a conta estiver ativa ou conforme exigência legal.</p>

        <h4 className="font-bold text-white mt-4">7. Cookies</h4>
        ...
        <h4 className="font-bold text-white mt-4">8. Contato</h4>
        <p>Para questões de privacidade: 📧 rdlsoftwares@gmail.com</p>

        <h4 className="font-bold text-white mt-4">9. Alterações</h4>
